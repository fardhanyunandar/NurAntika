  ...
  return (
    <>
      ...
      <nav id="navbar" className={navScrolled ? 'scrolled' : ''}>
        <div className="nav-wrap">
          ...
          <ul className="nav-links">
            ...
            <li>
              <a href="https://docs.google.com/forms/d/e/1FAIpQLSfnR9pMQaZ_7KntvSpAcv5D1j0MB7F7kJHF6XNt2_H-RnstQA/viewform?usp=sf_link" target="_blank" rel="noopener noreferrer" className="nav-cta">Pendaftaran</a>
            </li>
          </ul>
      ...
      <nav className={`mobile-nav ${mobileOpen ? 'open' : ''}`} id="mobileNav">
        ...
        <a onClick={() => navigate('fasilitas')}>Fasilitas</a>
        <a onClick={() => navigate('guru')}>Dewan Guru</a>
        <a onClick={() => navigate('pendaftaran')}>Pendaftaran</a>
        <a onClick={() => navigate('tanya')}>Tanya Jawab</a>
      ...
      {page === 'pendaftaran' && <PendaftaranPage navigate={navigate} />}
        ...
        <div className="hero-inner">
          <div className="hero-left">
            ...
            <div className="hero-stats">
              <div className="stat"><span className="stat-num">2012</span><span className="stat-label">Tahun Berdiri</span></div>
              <div className="stat"><span className="stat-num">3</span><span className="stat-label">Jenjang Sekolah</span></div>
              <div className="stat"><span className="stat-num">12+</span><span className="stat-label">Fasilitas</span></div>
              <div className="stat"><span className="stat-num">20+</span><span className="stat-label">Dewan Guru</span></div>
            </div>
          </div>
          <div className="hero-right">
            ...
            <div className="hero-video-row">
              <div className="hero-video-sm">
                <iframe src="https://www.youtube.com/embed/-JshqK6p_hU" title="Nur Antika 2" allowFullScreen loading="lazy"></iframe>
              </div>
              <div className="hero-cta-card" onClick={() => navigate('pendaftaran')}>
                <div className="cta-icon"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /></svg></div>
                <div className="cta-title">Pendaftaran<br />2026/2027</div>
                <div className="cta-sub">Lihat informasi &rarr;</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid-2 reveal">
          <div>
            ...
            <div className="social-row">
              {/* Facebook */}
              <a
                href="https://www.facebook.com/ponpes.nurantika.5?mibextid=ZbWKwL"
                target="_blank"
                rel="noopener noreferrer"
                className="soc-btn s-fb"
                style={{ '--brand-color': '#1877F2' }}
              >
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/ponpes_nurantika/"
                target="_blank"
                rel="noopener noreferrer"
                className="soc-btn s-ig"
                style={{ '--brand-color': '#E1306C' }}
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              ...
              {/* YouTube */}
              <a
                href="https://www.youtube.com/@pondokpesantrennurantika2489/featured"
                target="_blank"
                rel="noopener noreferrer"
                className="soc-btn s-yt"
                style={{ '--brand-color': '#FF0000' }}
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M23.498 6.163a3.003 3.003 0 00-2.11-2.113C19.515 3.545 12 3.545 12 3.545s-7.515 0-9.388.505a3.003 3.003 0 00-2.11 2.113C0 8.053 0 12 0 12s0 3.948.502 5.837a3.003 3.003 0 002.11 2.113c1.873.505 9.388.505 9.388.505s7.515 0 9.388-.505a3.003 3.003 0 002.11-2.113C24 15.948 24 12 24 12s0-3.947-.502-5.837zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                </svg>
                YouTube
              </a>
              ...
              {/* TikTok */}
              <a
                href="https://www.tiktok.com/@official_nurantika"
                target="_blank"
                rel="noopener noreferrer"
                className="soc-btn s-tk"
                style={{ '--brand-color': '#000000' }}
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12.525.02c1.31-.032 2.61-.019 3.91-.019.22 2.408 1.49 4.515 3.425 5.832V9.64c-1.3-.18-2.526-.74-3.557-1.547v7.322c0 4.7-3.93 8.56-8.66 8.56A8.63 8.63 0 0 1 .01 15.34a8.562 8.562 0 0 1 10.02-8.442v3.91a4.644 4.644 0 0 0-6.13 4.512 4.646 4.646 0 0 0 4.646 4.646 4.643 4.643 0 0 0 4.643-4.517V0h-.664z" />
                </svg>
                TikTok
              </a>
              ...
              {/* WhatsApp */}
              <a
                href="https://www.me/6282113463606"
                target="_blank"
                rel="noopener noreferrer"
                className="soc-btn s-wa"
                style={{ '--brand-color': '#25D366' }}
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397 0 11.948 0c3.173.001 6.154 1.24 8.396 3.486 2.24 2.245 3.475 5.23 3.473 8.402-.003 6.549-5.34 11.895-11.893 11.895-2.003-.001-3.972-.51-5.729-1.479L0 24zm6.59-4.846c1.657.982 3.284 1.503 4.804 1.504 5.462 0 9.904-4.44 9.906-9.903.001-2.646-1.027-5.133-2.896-7.005C16.533 1.88 14.04 .85 11.393.851c-5.465 0-9.91 4.444-9.912 9.908-.002 1.637.443 3.23 1.288 4.614l-.994 3.635 3.72-.975zM17.6 14.73c-.322-.16-1.905-.94-2.202-1.05-.297-.11-.513-.16-.73.16-.214.32-.83.105-1.015 1.26-.185.16-.37.19-.693.03a8.718 8.718 0 0 1-2.58-1.594 9.61 9.61 0 0 1-1.785-2.222c-.185-.32-.02-.493.14-.652.145-.143.323-.374.484-.56.162-.187.216-.32.324-.534.11-.213.054-.4-.027-.56-.08-.16-.73-1.76-.998-2.41-.26-.63-.525-.545-.723-.555-.185-.01-.4-.01-.615-.01-.215 0-.565.08-.86.4-.297.32-1.135 1.11-1.135 2.704 0 1.593 1.157 3.13 1.318 3.345.162.214 2.28 3.479 5.523 4.88.77.334 1.373.533 1.84.682.775.245 1.48.21 2.036.127.62-.093 1.907-.78 2.176-1.53.268-.75.268-1.39.187-1.53-.08-.14-.297-.22-.62-.38z" />
                </svg>
                WhatsApp
              </a>
            </div>
...
function PendaftaranPage({ navigate }) {
  return (
    <div id="page-pendaftaran">
      <div className="page-banner">
        <div className="page-banner-inner">
          <div className="breadcrumb"><a onClick={() => navigate('beranda')}>Beranda</a><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="9 18 15 12 9 6" /></svg><span>Pendaftaran</span></div>
          <h1>Pendaftaran</h1>
          <p>Pendaftaran Santri Baru Pondok Pesantren Nur Antika Tahun Ajaran 2026/2027.</p>
        </div>
      </div>
      <div className="section">
        <div className="reg-hero reveal">
          <h2>Pendaftaran Santri Baru</h2>
          <p>Pondok Pesantren Nur Antika &mdash; Tahun Ajaran 2026/2027</p>
          <div className="reg-btns">
            <a href="https://docs.google.com/forms/d/e/1FAIpQLSfnR9pMQaZ_7KntvSpAcv5D1j0MB7F7kJHF6XNt2_H-RnstQA/viewform?usp=sf_link" target="_blank" rel="noopener noreferrer" className="btn btn-light"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="12" y1="18" x2="12" y2="12" /><line x1="9" y1="15" x2="15" y2="15" /></svg>Daftar Online</a>
            <a href="https://drive.google.com/file/d/1xPHqfs2yHzGWrmAPe6t7wq1nCEpglMss/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="btn btn-ghost"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><polyline points="7 10 12 15 17 10" /><line x1="12" y1="15" x2="12" y2="3" /></svg>Unduh Brosur</a>
          </div>
        </div>
        ...
        <div className="brosur-grid reveal">
            ...
            <div className="brosur-visual brosur-landscape">
              <img
                ...
                alt="Tampak depan brosur pendaftaran"
                loading="lazy"
                style={{ width: '100%', height: '100%', objectFit: 'contain', display: 'block' }}
              />
              <span style={{ position: 'absolute', left: 0, right: 0, bottom: '1rem' }}></span>
            </div>
            <div className="brosur-label">Brosur Tampak Depan</div>
          </div>

          <div className="brosur-card">
            <div className="brosur-visual brosur-landscape">
              <img
                src={"/src/assets/brosur-belakang.png"}
                alt="Tampak belakang brosur pendaftaran"
                loading="lazy"
                style={{ width: '100%', height: '100%', objectFit: 'contain', display: 'block' }}
              />
              <span style={{ position: 'absolute', left: 0, right: 0, bottom: '1rem' }}></span>
            </div>
            <div className="brosur-label">Brosur Tampak Belakang</div>
          </div>
        </div>

        <div style={{ textAlign: 'center', marginBottom: '4rem' }} className="reveal">
          <a href="https://drive.google.com/file/d/1xPHqfs2yHzGWrmAPe6t7wq1nCEpglMss/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="btn btn-green" style={{ marginRight: '1rem' }}><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><polyline points="7 10 12 15 17 10" /><line x1="12" y1="15" x2="12" y2="3" /></svg>Unduh Brosur</a>
          <a href="https://docs.google.com/forms/d/e/1FAIpQLSfnR9pMQaZ_7KntvSpAcv5D1j0MB7F7kJHF6XNt2_H-RnstQA/viewform?usp=sf_link" target="_blank" rel="noopener noreferrer" className="btn btn-stroke"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /></svg>Daftar Online</a>
        </div>

        <div className="sec-header-center reveal"><div className="sec-tag">Langkah</div><h2 className="sec-h2">Cara <em>Mendaftar</em></h2><div className="sec-rule"></div></div>
        <div className="steps-grid reveal">
          <div className="step-card"><div className="step-num">01</div><div className="step-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><polyline points="7 10 12 15 17 10" /><line x1="12" y1="15" x2="12" y2="3" /></svg></div><h3>Unduh Brosur</h3><p>Unduh brosur pendaftaran untuk mengetahui informasi lengkap mengenai syarat, jadwal, dan prosedur pendaftaran santri baru.</p></div>
          <div className="step-card"><div className="step-num">02</div><div className="step-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="12" y1="18" x2="12" y2="12" /><line x1="9" y1="15" x2="15" y2="15" /></svg></div><h3>Isi Formulir Online</h3><p>Klik tombol Daftar Online untuk mengisi formulir pendaftaran yang tersedia. Pastikan semua data diisi dengan lengkap dan benar.</p></div>
          <div className="step-card"><div className="step-num">03</div><div className="step-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 9.5a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.62 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" /></svg></div><h3>Hubungi Kami</h3><p>Untuk pertanyaan lebih lanjut, hubungi kami via WhatsApp di 082113463606 atau email pondokpesantrennurantika@gmail.com.</p></div>
        </div>

        <div className="cta-box reveal">
          <h3>Butuh Informasi Lebih Lanjut?</h3>
          <p>Tim kami siap membantu menjawab setiap pertanyaan Anda mengenai pendaftaran dan program pendidikan di Pondok Pesantren Nur Antika.</p>
          <div className="cta-box-btns">
            <a href="https://wa.me/6282113463606" target="_blank" rel="noopener noreferrer" className="btn btn-green"><svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413Z" /></svg>Chat WhatsApp</a>
            <a href="mailto:pondokpesantrennurantika@gmail.com" className="btn btn-stroke">Kirim Email</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="foot-inner">
        <div className="foot-top">
          ...
          <div className="foot-col">
            ...
            <ul><li><a onClick={() => navigate('guru')}>Dewan Guru</a></li><li><a onClick={() => navigate('pendaftaran')}>Pendaftaran</a></li><li><a onClick={() => navigate('tanya')}>Tanya Jawab</a></li></ul>
          </div>
          <div className="foot-col">
            <h4>Kontak</h4>
